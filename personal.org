...
** INPROGRESS ~capnproto~ serialization/RPC
** BLOCKED build/distribute a ~manylinux1~ wheel and ~pex~
...
*** INPROGRESS automate building all three wheels [0/4]
...
** TODO figure out how to do schema updates
